...
def set_rules(bot: Bot, update: Update):
    ...
    if len(args) == 2:
        ...
        update.effective_message.reply_text("Bu qrup üçün qaydalar yadda saxlanıldı.")
...
def __stats__():
    return "{} qrup qaydalar tətbiq edib.".format(sql.num_chats())
...
def __chat_settings__(chat_id, user_id):
    return "Bu qrupdakı qaydalar: `{}`".format(bool(sql.get_rules(chat_id)))


__help__ = """
 - /rules: hazırki qrupun qaydaları gətirir.

*Sadəcə adminlər:*
 - /setrules <qaydalae>: qrupda qaydaları ayarlıyır.
