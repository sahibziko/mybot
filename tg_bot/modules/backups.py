...
def import_data(bot: Bot, update):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        try:
            ...
            msg.reply_text("Faylı daxil etməzdən əvvəl özünüz yükləyin - burda problem oldu "
                           "Təəssüf!")
            return
        ...
        if len(data) > 1 and str(chat.id) not in data:
            msg.reply_text("Bu faylda birdən çox qrup var, və heç bir qrupun id si bu qrupun idsi ilə eyni deyil "
                           "- onlardan hansını idxal edə bilərəmki? heçbirini")
            return
        ...
        try:
            ...
            msg.reply_text("Bir xəta yarandı və əməliyyat uğursuz oldu. :(")
