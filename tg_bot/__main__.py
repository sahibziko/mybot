...
PM_START_TEXT = """
Salam {}, mənim adım *{}*dir! məni işlətmək ilə bağlı kömək almaq üçün /help yazmağın kifayətdir... 
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Çox Şükür Allaha Mən Buradayam☺")
    ...
    if user:
        ...
        if CHAT_SETTINGS:
            ...
            dispatcher.bot.send_message(user_id, "Mövcud söhbət ayarları olmadığı görünür. "
                                                 "Bunu admin olduğunuz qrupda yazın!",
                                        parse_mode=ParseMode.MARKDOWN)
...
def settings_button(bot: Bot, update: Update):
    ...
    try:
        if mod_match:
            ...
            text = "*{}* qrupunun *{}* modulu ilə bağlı ayarları bunlardır:\n\n".format(escape_markdown(chat.title),
